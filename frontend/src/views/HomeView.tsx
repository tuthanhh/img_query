    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white p-4 animate-in fade-in duration-500">
      <div className="w-full max-w-2xl flex flex-col items-center">
        ...
        <div className="w-full">
          ...
          {showAdvanced && (
            <div className="mt-6 p-6 bg-gray-50 rounded-xl border border-gray-100 w-full grid grid-cols-1 md:grid-cols-2 gap-6 animate-in slide-in-from-top-2 duration-300 shadow-sm">
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-500 focus:border-brand-500 text-sm appearance-none cursor-pointer"
                  >
